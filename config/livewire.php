...
return [
    ...
    */
    ...
    'make_command' => [
        // Componentes em classe: a lógica do Cerne (tenancy, privacidade do casal,
        // parcelamento) é pesada demais para viver dentro do Blade, e classes são
        // testáveis isoladamente. Emoji desligado para não arriscar encoding de
        // nome de arquivo entre Windows, Git e o servidor Linux da Hostinger.
