...
@else
    {{-- overflow-x-auto próprio: sem isto, no celular a tabela só
         cortava (o card pai usa overflow-hidden pra manter o canto
         arredondado) em vez de deixar rolar de lado como "Outras
         contas" já fazia — ver admin-users.blade.php. --}}
