...
<svg {{ $attributes->merge(['class' => 'h-5 w-5 shrink-0']) }} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    @switch($name)
        ...
        @case('mail')
            ...
            @break
        @case('phone')
            <path d="M13.3 21a17 17 0 0 1-9.3-9.3 3.3 3.3 0 0 1 .8-3.6l1.7-1.7a1.7 1.7 0 0 1 2.5.2l1.4 1.9a1.7 1.7 0 0 1-.1 2.2l-.7.7a12 12 0 0 0 4.9 4.9l.7-.7a1.7 1.7 0 0 1 2.2-.1l1.9 1.4a1.7 1.7 0 0 1 .2 2.5l-1.7 1.7a3.3 3.3 0 0 1-3.6.8Z"/>
            @break
        @case('whatsapp')
            <path d="M12 3a9 9 0 1 0 6.5 15.3L21 21l-2.7-2.5A9 9 0 0 0 12 3Z"/><path d="M8.5 10c0 3 2.5 5.5 5.5 5.5"/>
            @break
        @case('admin')
            <path d="M10.3 3.4a1.7 1.7 0 0 1 3.4 0 1.7 1.7 0 0 0 2.5 1.5 1.7 1.7 0 0 1 2.4 2.4 1.7 1.7 0 0 0 1.5 2.5 1.7 1.7 0 0 1 0 3.4 1.7 1.7 0 0 0-1.5 2.5 1.7 1.7 0 0 1-2.4 2.4 1.7 1.7 0 0 0-2.5 1.5 1.7 1.7 0 0 1-3.4 0 1.7 1.7 0 0 0-2.5-1.5 1.7 1.7 0 0 1-2.4-2.4 1.7 1.7 0 0 0-1.5-2.5 1.7 1.7 0 0 1 0-3.4 1.7 1.7 0 0 0 1.5-2.5 1.7 1.7 0 0 1 2.4-2.4 1.7 1.7 0 0 0 2.5-1.5Z"/><circle cx="12" cy="12" r="3"/>
            @break
        @default
